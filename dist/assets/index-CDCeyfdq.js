 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(B,G){var X=B.length;B.push(G);e:for(;0<X;){var me=X-1>>>1,ae=B[me];if(0<i(ae,G))B[me]=G,B[X]=ae,X=me;else break e}}function n(B){return B.length===0?null:B[0]}function r(B){if(B.length===0)return null;var G=B[0],X=B.pop();if(X!==G){B[0]=X;e:for(var me=0,ae=B.length,Te=ae>>>1;me<Te;){var rn=2*(me+1)-1,sn=B[rn],on=rn+1,an=B[on];if(0>i(sn,X))on<ae&&0>i(an,sn)?(B[me]=an,B[on]=X,me=on):(B[me]=sn,B[rn]=X,me=rn);else if(on<ae&&0>i(an,X))B[me]=an,B[on]=X,me=on;else break e}}return G}function i(B,G){var X=B.sortIndex-G.sortIndex;return X!==0?X:B.id-G.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],h=[],f=1,g=null,_=3,A=!1,P=!1,x=!1,V=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,w=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function S(B){for(var G=n(h);G!==null;){if(G.callback===null)r(h);else if(G.startTime<=B)r(h),G.sortIndex=G.expirationTime,e(u,G);else break;G=n(h)}}function D(B){if(x=!1,S(B),!P)if(n(u)!==null)P=!0,Gi(j);else{var G=n(h);G!==null&&nn(D,G.startTime-B)}}function j(B,G){P=!1,x&&(x=!1,I(m),m=-1),A=!0;var X=_;try{for(S(G),g=n(u);g!==null&&(!(g.expirationTime>G)||B&&!R());){var me=g.callback;if(typeof me=="function"){g.callback=null,_=g.priorityLevel;var ae=me(g.expirationTime<=G);G=t.unstable_now(),typeof ae=="function"?g.callback=ae:g===n(u)&&r(u),S(G)}else r(u);g=n(u)}if(g!==null)var Te=!0;else{var rn=n(h);rn!==null&&nn(D,rn.startTime-G),Te=!1}return Te}finally{g=null,_=X,A=!1}}var b=!1,y=null,m=-1,v=5,E=-1;function R(){return!(t.unstable_now()-E<v)}function C(){if(y!==null){var B=t.unstable_now();E=B;var G=!0;try{G=y(!0,B)}finally{G?T():(b=!1,y=null)}}else b=!1}var T;if(typeof w=="function")T=function(){w(C)};else if(typeof MessageChannel<"u"){var St=new MessageChannel,dr=St.port2;St.port1.onmessage=C,T=function(){dr.postMessage(null)}}else T=function(){V(C,0)};function Gi(B){y=B,b||(b=!0,T())}function nn(B,G){m=V(function(){B(t.unstable_now())},G)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(B){B.callback=null},t.unstable_continueExecution=function(){P||A||(P=!0,Gi(j))},t.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):v=0<B?Math.floor(1e3/B):5},t.unstable_getCurrentPriorityLevel=function(){return _},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(B){switch(_){case 1:case 2:case 3:var G=3;break;default:G=_}var X=_;_=G;try{return B()}finally{_=X}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(B,G){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var X=_;_=B;try{return G()}finally{_=X}},t.unstable_scheduleCallback=function(B,G,X){var me=t.unstable_now();switch(typeof X=="object"&&X!==null?(X=X.delay,X=typeof X=="number"&&0<X?me+X:me):X=me,B){case 1:var ae=-1;break;case 2:ae=250;break;case 5:ae=1073741823;break;case 4:ae=1e4;break;default:ae=5e3}return ae=X+ae,B={id:f++,callback:G,priorityLevel:B,startTime:X,expirationTime:ae,sortIndex:-1},X>me?(B.sortIndex=X,e(h,B),n(u)===null&&B===n(h)&&(x?(I(m),m=-1):x=!0,nn(D,X-me))):(B.sortIndex=ae,e(u,B),P||A||(P=!0,Gi(j))),B},t.unstable_shouldYield=R,t.unstable_wrapCallback=function(B){var G=_;return function(){var X=_;_=G;try{return B.apply(this,arguments)}finally{_=X}}}})(Sy);Iy.exports=Sy;var eT=Iy.exports;/**
 * @license React
...
*/var Cr,Uv;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(y,m){function v(){}v.prototype=m.prototype,y.D=m.prototype,y.prototype=new v,y.prototype.constructor=y,y.C=function(E,R,C){for(var T=Array(arguments.length-2),St=2;St<arguments.length;St++)T[St-2]=arguments[St];return m.prototype[R].apply(E,T)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(y,m,v){v||(v=0);var E=Array(16);if(typeof m=="string")for(var R=0;16>R;++R)E[R]=m.charCodeAt(v++)|m.charCodeAt(v++)<<8|m.charCodeAt(v++)<<16|m.charCodeAt(v++)<<24;else for(R=0;16>R;++R)E[R]=m[v++]|m[v++]<<8|m[v++]<<16|m[v++]<<24;m=y.g[0],v=y.g[1],R=y.g[2];var C=y.g[3],T=m+(C^v&(R^C))+E[0]+3614090360&4294967295;m=v+(T<<7&4294967295|T>>>25),T=C+(R^m&(v^R))+E[1]+3905402710&4294967295,C=m+(T<<12&4294967295|T>>>20),T=R+(v^C&(m^v))+E[2]+606105819&4294967295,R=C+(T<<17&4294967295|T>>>15),T=v+(m^R&(C^m))+E[3]+3250441966&4294967295,v=R+(T<<22&4294967295|T>>>10),T=m+(C^v&(R^C))+E[4]+4118548399&4294967295,m=v+(T<<7&4294967295|T>>>25),T=C+(R^m&(v^R))+E[5]+1200080426&4294967295,C=m+(T<<12&4294967295|T>>>20),T=R+(v^C&(m^v))+E[6]+2821735955&4294967295,R=C+(T<<17&4294967295|T>>>15),T=v+(m^R&(C^m))+E[7]+4249261313&4294967295,v=R+(T<<22&4294967295|T>>>10),T=m+(C^v&(R^C))+E[8]+1770035416&4294967295,m=v+(T<<7&4294967295|T>>>25),T=C+(R^m&(v^R))+E[9]+2336552879&4294967295,C=m+(T<<12&4294967295|T>>>20),T=R+(v^C&(m^v))+E[10]+4294925233&4294967295,R=C+(T<<17&4294967295|T>>>15),T=v+(m^R&(C^m))+E[11]+2304563134&4294967295,v=R+(T<<22&4294967295|T>>>10),T=m+(C^v&(R^C))+E[12]+1804603682&4294967295,m=v+(T<<7&4294967295|T>>>25),T=C+(R^m&(v^R))+E[13]+4254626195&4294967295,C=m+(T<<12&4294967295|T>>>20),T=R+(v^C&(m^v))+E[14]+2792965006&4294967295,R=C+(T<<17&4294967295|T>>>15),T=v+(m^R&(C^m))+E[15]+1236535329&4294967295,v=R+(T<<22&4294967295|T>>>10),T=m+(R^C&(v^R))+E[1]+4129170786&4294967295,m=v+(T<<5&4294967295|T>>>27),T=C+(v^R&(m^v))+E[6]+3225465664&4294967295,C=m+(T<<9&4294967295|T>>>23),T=R+(m^v&(C^m))+E[11]+643717713&4294967295,R=C+(T<<14&4294967295|T>>>18),T=v+(C^m&(R^C))+E[0]+3921069994&4294967295,v=R+(T<<20&4294967295|T>>>12),T=m+(R^C&(v^R))+E[5]+3593408605&4294967295,m=v+(T<<5&4294967295|T>>>27),T=C+(v^R&(m^v))+E[10]+38016083&4294967295,C=m+(T<<9&4294967295|T>>>23),T=R+(m^v&(C^m))+E[15]+3634488961&4294967295,R=C+(T<<14&4294967295|T>>>18),T=v+(C^m&(R^C))+E[4]+3889429448&4294967295,v=R+(T<<20&4294967295|T>>>12),T=m+(R^C&(v^R))+E[9]+568446438&4294967295,m=v+(T<<5&4294967295|T>>>27),T=C+(v^R&(m^v))+E[14]+3275163606&4294967295,C=m+(T<<9&4294967295|T>>>23),T=R+(m^v&(C^m))+E[3]+4107603335&4294967295,R=C+(T<<14&4294967295|T>>>18),T=v+(C^m&(R^C))+E[8]+1163531501&4294967295,v=R+(T<<20&4294967295|T>>>12),T=m+(R^C&(v^R))+E[13]+2850285829&4294967295,m=v+(T<<5&4294967295|T>>>27),T=C+(v^R&(m^v))+E[2]+4243563512&4294967295,C=m+(T<<9&4294967295|T>>>23),T=R+(m^v&(C^m))+E[7]+1735328473&4294967295,R=C+(T<<14&4294967295|T>>>18),T=v+(C^m&(R^C))+E[12]+2368359562&4294967295,v=R+(T<<20&4294967295|T>>>12),T=m+(v^R^C)+E[5]+4294588738&4294967295,m=v+(T<<4&4294967295|T>>>28),T=C+(m^v^R)+E[8]+2272392833&4294967295,C=m+(T<<11&4294967295|T>>>21),T=R+(C^m^v)+E[11]+1839030562&4294967295,R=C+(T<<16&4294967295|T>>>16),T=v+(R^C^m)+E[14]+4259657740&4294967295,v=R+(T<<23&4294967295|T>>>9),T=m+(v^R^C)+E[1]+2763975236&4294967295,m=v+(T<<4&4294967295|T>>>28),T=C+(m^v^R)+E[4]+1272893353&4294967295,C=m+(T<<11&4294967295|T>>>21),T=R+(C^m^v)+E[7]+4139469664&4294967295,R=C+(T<<16&4294967295|T>>>16),T=v+(R^C^m)+E[10]+3200236656&4294967295,v=R+(T<<23&4294967295|T>>>9),T=m+(v^R^C)+E[13]+681279174&4294967295,m=v+(T<<4&4294967295|T>>>28),T=C+(m^v^R)+E[0]+3936430074&4294967295,C=m+(T<<11&4294967295|T>>>21),T=R+(C^m^v)+E[3]+3572445317&4294967295,R=C+(T<<16&4294967295|T>>>16),T=v+(R^C^m)+E[6]+76029189&4294967295,v=R+(T<<23&4294967295|T>>>9),T=m+(v^R^C)+E[9]+3654602809&4294967295,m=v+(T<<4&4294967295|T>>>28),T=C+(m^v^R)+E[12]+3873151461&4294967295,C=m+(T<<11&4294967295|T>>>21),T=R+(C^m^v)+E[15]+530742520&4294967295,R=C+(T<<16&4294967295|T>>>16),T=v+(R^C^m)+E[2]+3299628645&4294967295,v=R+(T<<23&4294967295|T>>>9),T=m+(R^(v|~C))+E[0]+4096336452&4294967295,m=v+(T<<6&4294967295|T>>>26),T=C+(v^(m|~R))+E[7]+1126891415&4294967295,C=m+(T<<10&4294967295|T>>>22),T=R+(m^(C|~v))+E[14]+2878612391&4294967295,R=C+(T<<15&4294967295|T>>>17),T=v+(C^(R|~m))+E[5]+4237533241&4294967295,v=R+(T<<21&4294967295|T>>>11),T=m+(R^(v|~C))+E[12]+1700485571&4294967295,m=v+(T<<6&4294967295|T>>>26),T=C+(v^(m|~R))+E[3]+2399980690&4294967295,C=m+(T<<10&4294967295|T>>>22),T=R+(m^(C|~v))+E[10]+4293915773&4294967295,R=C+(T<<15&4294967295|T>>>17),T=v+(C^(R|~m))+E[1]+2240044497&4294967295,v=R+(T<<21&4294967295|T>>>11),T=m+(R^(v|~C))+E[8]+1873313359&4294967295,m=v+(T<<6&4294967295|T>>>26),T=C+(v^(m|~R))+E[15]+4264355552&4294967295,C=m+(T<<10&4294967295|T>>>22),T=R+(m^(C|~v))+E[6]+2734768916&4294967295,R=C+(T<<15&4294967295|T>>>17),T=v+(C^(R|~m))+E[13]+1309151649&4294967295,v=R+(T<<21&4294967295|T>>>11),T=m+(R^(v|~C))+E[4]+4149444226&4294967295,m=v+(T<<6&4294967295|T>>>26),T=C+(v^(m|~R))+E[11]+3174756917&4294967295,C=m+(T<<10&4294967295|T>>>22),T=R+(m^(C|~v))+E[2]+718787259&4294967295,R=C+(T<<15&4294967295|T>>>17),T=v+(C^(R|~m))+E[9]+3951481745&4294967295,y.g[0]=y.g[0]+m&4294967295,y.g[1]=y.g[1]+(R+(T<<21&4294967295|T>>>11))&4294967295,y.g[2]=y.g[2]+R&4294967295,y.g[3]=y.g[3]+C&4294967295}r.prototype.u=function(y,m){m===void 0&&(m=y.length);for(var v=m-this.blockSize,E=this.B,R=this.h,C=0;C<m;){if(R==0)for(;C<=v;)i(this,y,C),C+=this.blockSize;if(typeof y=="string"){for(;C<m;)if(E[R++]=y.charCodeAt(C++),R==this.blockSize){i(this,E),R=0;break}}else for(;C<m;)if(E[R++]=y[C++],R==this.blockSize){i(this,E),R=0;break}}this.h=R,this.o+=m},r.prototype.v=function(){var y=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);y[0]=128;for(var m=1;m<y.length-8;++m)y[m]=0;var v=8*this.o;for(m=y.length-8;m<y.length;++m)y[m]=v&255,v/=256;for(this.u(y),y=Array(16),m=v=0;4>m;++m)for(var E=0;32>E;E+=8)y[v++]=this.g[m]>>>E&255;return y};function s(y,m){var v=l;return Object.prototype.hasOwnProperty.call(v,y)?v[y]:v[y]=m(y)}function o(y,m){this.h=m;for(var v=[],E=!0,R=y.length-1;0<=R;R--){var C=y[R]|0;E&&C==m||(v[R]=C,E=!1)}this.g=v}var l={};function u(y){return-128<=y&&128>y?s(y,function(m){return new o([m|0],0>m?-1:0)}):new o([y|0],0>y?-1:0)}function h(y){if(isNaN(y)||!isFinite(y))return g;if(0>y)return V(h(-y));for(var m=[],v=1,E=0;y>=v;E++)m[E]=y/v|0,v*=4294967296;return new o(m,0)}function f(y,m){if(y.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(y.charAt(0)=="-")return V(f(y.substring(1),m));if(0<=y.indexOf("-"))throw Error('number format error: interior "-" character');for(var v=h(Math.pow(m,8)),E=g,R=0;R<y.length;R+=8){var C=Math.min(8,y.length-R),T=parseInt(y.substring(R,R+C),m);8>C?(C=h(Math.pow(m,C)),E=E.j(C).add(h(T))):(E=E.j(v),E=E.add(h(T)))}return E}var g=u(0),_=u(1),A=u(16777216);t=o.prototype,t.m=function(){if(x(this))return-V(this).m();for(var y=0,m=1,v=0;v<this.g.length;v++){var E=this.i(v);y+=(0<=E?E:4294967296+E)*m,m*=4294967296}return y},t.toString=function(y){if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(P(this))return"0";if(x(this))return"-"+V(this).toString(y);for(var m=h(Math.pow(y,6)),v=this,E="";;){var R=D(v,m).g;v=I(v,R.j(m));var C=((0<v.g.length?v.g[0]:v.h)>>>0).toString(y);if(v=R,P(v))return C+E;for(;6>C.length;)C="0"+C;E=C+E}},t.i=function(y){return 0>y?0:y<this.g.length?this.g[y]:this.h};function P(y){if(y.h!=0)return!1;for(var m=0;m<y.g.length;m++)if(y.g[m]!=0)return!1;return!0}function x(y){return y.h==-1}t.l=function(y){return y=I(this,y),x(y)?-1:P(y)?0:1};function V(y){for(var m=y.g.length,v=[],E=0;E<m;E++)v[E]=~y.g[E];return new o(v,~y.h).add(_)}t.abs=function(){return x(this)?V(this):this},t.add=function(y){for(var m=Math.max(this.g.length,y.g.length),v=[],E=0,R=0;R<=m;R++){var C=E+(this.i(R)&65535)+(y.i(R)&65535),T=(C>>>16)+(this.i(R)>>>16)+(y.i(R)>>>16);E=T>>>16,C&=65535,T&=65535,v[R]=T<<16|C}return new o(v,v[v.length-1]&-2147483648?-1:0)};function I(y,m){return y.add(V(m))}t.j=function(y){if(P(this)||P(y))return g;if(x(this))return x(y)?V(this).j(V(y)):V(V(this).j(y));if(x(y))return V(this.j(V(y)));if(0>this.l(A)&&0>y.l(A))return h(this.m()*y.m());for(var m=this.g.length+y.g.length,v=[],E=0;E<2*m;E++)v[E]=0;for(E=0;E<this.g.length;E++)for(var R=0;R<y.g.length;R++){var C=this.i(E)>>>16,T=this.i(E)&65535,St=y.i(R)>>>16,dr=y.i(R)&65535;v[2*E+2*R]+=T*dr,w(v,2*E+2*R),v[2*E+2*R+1]+=C*dr,w(v,2*E+2*R+1),v[2*E+2*R+1]+=T*St,w(v,2*E+2*R+1),v[2*E+2*R+2]+=C*St,w(v,2*E+2*R+2)}for(E=0;E<m;E++)v[E]=v[2*E+1]<<16|v[2*E];for(E=m;E<2*m;E++)v[E]=0;return new o(v,0)};function w(y,m){for(;(y[m]&65535)!=y[m];)y[m+1]+=y[m]>>>16,y[m]&=65535,m++}function S(y,m){this.g=y,this.h=m}function D(y,m){if(P(m))throw Error("division by zero");if(P(y))return new S(g,g);if(x(y))return m=D(V(y),m),new S(V(m.g),V(m.h));if(x(m))return m=D(y,V(m)),new S(V(m.g),m.h);if(30<y.g.length){if(x(y)||x(m))throw Error("slowDivide_ only works with positive integers.");for(var v=_,E=m;0>=E.l(y);)v=j(v),E=j(E);var R=b(v,1),C=b(E,1);for(E=b(E,2),v=b(v,2);!P(E);){var T=C.add(E);0>=T.l(y)&&(R=R.add(v),C=T),E=b(E,1),v=b(v,1)}return m=I(y,R.j(m)),new S(R,m)}for(R=g;0<=y.l(m);){for(v=Math.max(1,Math.floor(y.m()/m.m())),E=Math.ceil(Math.log(v)/Math.LN2),E=48>=E?1:Math.pow(2,E-48),C=h(v),T=C.j(m);x(T)||0<T.l(y);)v-=E,C=h(v),T=C.j(m);P(C)&&(C=_),R=R.add(C),y=I(y,T)}return new S(R,y)}t.A=function(y){return D(this,y).h},t.and=function(y){for(var m=Math.max(this.g.length,y.g.length),v=[],E=0;E<m;E++)v[E]=this.i(E)&y.i(E);return new o(v,this.h&y.h)},t.or=function(y){for(var m=Math.max(this.g.length,y.g.length),v=[],E=0;E<m;E++)v[E]=this.i(E)|y.i(E);return new o(v,this.h|y.h)},t.xor=function(y){for(var m=Math.max(this.g.length,y.g.length),v=[],E=0;E<m;E++)v[E]=this.i(E)^y.i(E);return new o(v,this.h^y.h)};function j(y){for(var m=y.g.length+1,v=[],E=0;E<m;E++)v[E]=y.i(E)<<1|y.i(E-1)>>>31;return new o(v,y.h)}function b(y,m){var v=m>>5;m%=32;for(var E=y.g.length-v,R=[],C=0;C<E;C++)R[C]=0<m?y.i(C+v)>>>m|y.i(C+v+1)<<32-m:y.i(C+v);return new o(R,y.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,Uv=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,Cr=o}).apply(typeof Qm<"u"?Qm:typeof self<"u"?self:typeof window<"u"?window:{});var ca=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cR{constructor(){this.changes=new Hi(e=>e.toString(),(e,n)=>e.isEqual(n)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,Je.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const r=this.changes.get(n);return r!==void 0?O.resolve(r):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function La(t,e,n){return`firebase:${t}:${e}:${n}`}class Ti{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=La(this.userKey,i.apiKey,s),this.fullPersistenceKey=La("persistence",i.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?yn._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new Ti(_n(Fg),e,r);const i=(await Promise.all(n.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let s=i[0]||_n(Fg);const o=La(r,e.config.apiKey,e.name);let l=null;for(const h of n)try{const f=await h._get(o);if(f){const g=yn._fromJSON(e,f);h!==s&&(l=g),s=h;break}}catch{}const u=i.filter(h=>h._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new Ti(s,e,r):(s=u[0],l&&await s._set(o,l.toJSON()),await Promise.all(n.map(async h=>{if(h!==s)try{await h._remove(o)}catch{}})),new Ti(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ug(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(f0(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(c0(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(m0(e))return"Blackberry";if(g0(e))return"Webos";if(h0(e))return"Safari";if((e.includes("chrome/")||d0(e))&&!e.includes("edge/"))return"Chrome";if(p0(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function c0(t=et()){return/firefox\//i.test(t)}function h0(t=et()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function d0(t=et()){return/crios\//i.test(t)}function f0(t=et()){return/iemobile/i.test(t)}function p0(t=et()){return/android/i.test(t)}function m0(t=et()){return/blackberry/i.test(t)}function g0(t=et()){return/webos/i.test(t)}function vf(t=et()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function fC(t=et()){var e;return vf(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function pC(){return vS()&&document.documentMode===10}function y0(t=et()){return vf(t)||p0(t)||g0(t)||m0(t)||/windows phone/i.test(t)||f0(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _0(t,e=[]){let n;switch(t){case"Browser":n=Ug(et());break;case"Worker":n=`${Ug(et())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${$i}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kP={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},CP=500,PP=600,xP="_blank",NP="http://localhost";class Gg{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function DP(t,e,n,r=CP,i=PP){const s=Math.max((window.screen.availHeight-i)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let l="";const u=Object.assign(Object.assign({},kP),{width:r.toString(),height:i.toString(),top:s,left:o}),h=et().toLowerCase();n&&(l=d0(h)?xP:n),c0(h)&&(e=e||NP,u.scrollbars="yes");const f=Object.entries(u).reduce((_,[A,P])=>`${_}${A}=${P},`,"");if(fC(h)&&l!=="_self")return VP(e||"",l),new Gg(null);const g=window.open(e||"",l,f);q(g,t,"popup-blocked");try{g.focus()}catch{}return new Gg(g)}function VP(t,e){const n=document.createElement("a");n.href=t,n.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const OP="__/auth/handler",LP="emulator/auth/handler",MP=encodeURIComponent("fac");async function Qg(t,e,n,r,i,s){q(t.config.authDomain,t,"auth-domain-config-required"),q(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:$i,eventId:i};if(e instanceof Ef){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",AS(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,g]of Object.entries({}))o[f]=g}if(e instanceof ko){const f=e.getScopes().filter(g=>g!=="");f.length>0&&(o.scopes=f.join(","))}t.tenantId&&(o.tid=t.tenantId);const l=o;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const u=await t._getAppCheckToken(),h=u?`#${MP}=${encodeURIComponent(u)}`:"";return`${bP(t)}?${vo(l).slice(1)}${h}`}function bP({config:t}){return t.emulator?gf(t,LP):`https://${t.authDomain}/${OP}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ft=new $l("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fx(t){if(!t.startsWith(Cf)){const e=wt.create("invalid-gtag-resource",{gtagURL:t});return ft.warn(e.message),""}return t}function X0(t){return Promise.all(t.map(e=>e.catch(n=>n)))}function Ux(t,e){let n;return window.trustedTypes&&(n=window.trustedTypes.createPolicy(t,e)),n}function jx(t,e){const n=Ux("firebase-js-sdk-policy",{createScriptURL:Fx}),r=document.createElement("script"),i=`${Cf}?l=${t}&id=${e}`;r.src=n?n==null?void 0:n.createScriptURL(i):i,r.async=!0,document.head.appendChild(r)}function Bx(t){let e=[];return Array.isArray(window[t])?e=window[t]:window[t]=e,e}async function zx(t,e,n,r,i,s){const o=r[i];try{if(o)await e[o];else{const u=(await X0(n)).find(h=>h.measurementId===i);u&&await e[u.appId]}}catch(l){ft.error(l)}t("config",i,s)}async function $x(t,e,n,r,i){try{let s=[];if(i&&i.send_to){let o=i.send_to;Array.isArray(o)||(o=[o]);const l=await X0(n);for(const u of o){const h=l.find(g=>g.measurementId===u),f=h&&e[h.appId];if(f)s.push(f);else{s=[];break}}}s.length===0&&(s=Object.values(e)),await Promise.all(s),t("event",r,i||{})}catch(s){ft.error(s)}}function Wx(t,e,n,r){async function i(s,...o){try{if(s==="event"){const[l,u]=o;await $x(t,e,n,l,u)}else if(s==="config"){const[l,u]=o;await zx(t,e,n,r,l,u)}else if(s==="consent"){const[l,u]=o;t("consent",l,u)}else if(s==="get"){const[l,u,h]=o;t("get",l,u,h)}else if(s==="set"){const[l]=o;t("set",l)}else t(s,...o)}catch(l){ft.error(l)}}return i}function Hx(t,e,n,r,i){let s=function(...o){window[r].push(arguments)};return window[i]&&typeof window[i]=="function"&&(s=window[i]),window[i]=Wx(s,t,e,n),{gtagCore:s,wrappedGtag:window[i]}}function qx(t){const e=window.document.getElementsByTagName("script");for(const n of Object.values(e))if(n.src&&n.src.includes(Cf)&&n.src.includes(t))return n;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rN(){if(Nv())try{await Dv()}catch(t){return ft.warn(wt.create("indexeddb-unavailable",{errorInfo:t==null?void 0:t.toString()}).message),!1}else return ft.warn(wt.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function iN(t,e,n,r,i,s,o){var l;const u=Jx(t);u.then(A=>{n[A.measurementId]=A.appId,t.options.measurementId&&A.measurementId!==t.options.measurementId&&ft.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${A.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(A=>ft.error(A)),e.push(u);const h=rN().then(A=>{if(A)return r.getId()}),[f,g]=await Promise.all([u,h]);qx(s)||jx(s,f.measurementId),i("js",new Date);const _=(l=o==null?void 0:o.config)!==null&&l!==void 0?l:{};return _[Ox]="firebase",_.update=!0,g!=null&&(_[Vx]=g),i("config",f.measurementId,_),f.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sN{constructor(e){this.app=e}_delete(){return delete Us[this.app.options.appId],Promise.resolve()}}let Us={},ty=[];const ny={};let wc="dataLayer",oN="gtag",ry,eE,iy=!1;function aN(){const t=[];if(xv()&&t.push("This is a browser extension environment."),ES()||t.push("Cookies are not available."),t.length>0){const e=t.map((r,i)=>`(${i+1}) ${r}`).join(" "),n=wt.create("invalid-analytics-context",{errorInfo:e});ft.warn(n.message)}}function lN(t,e,n){aN();const r=t.options.appId;if(!r)throw wt.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)ft.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw wt.create("no-api-key");if(Us[r]!=null)throw wt.create("already-exists",{id:r});if(!iy){Bx(wc);const{wrappedGtag:s,gtagCore:o}=Hx(Us,ty,ny,wc,oN);eE=s,ry=o,iy=!0}return Us[r]=iN(t,ty,ny,e,ry,wc,n),new sN(t)}function uN(t=Vd()){t=Ne(t);const e=Hr(t,Al);return e.isInitialized()?e.getImmediate():cN(t)}function cN(t,e={}){const n=Hr(t,Al);if(n.isInitialized()){const i=n.getImmediate();if(ro(e,n.getOptions()))return i;throw wt.create("already-initialized")}return n.initialize({options:e})}function hN(t,e,n,r){t=Ne(t),nN(eE,Us[t.app.options.appId],e,n,r).catch(i=>ft.error(i))}const sy="@firebase/analytics",oy="0.10.8";function dN(){Jt(new zt(Al,(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return lN(r,i,n)},"PUBLIC")),Jt(new zt("analytics-internal",t,"PRIVATE")),Pt(sy,oy),Pt(sy,oy,"esm2017");function t(e){try{const n=e.getProvider(Al).getImmediate();return{logEvent:(r,i,s)=>hN(n,r,i,s)}}catch(n){throw wt.create("interop-component-reg-failed",{reason:n})}}}dN();const fN={apiKey:"AIzaSyDZYZANCqnJdLEZ-KWJfCwMbLMTtn2YsBw",authDomain:"luis-board-7fce3.firebaseapp.com",projectId:"luis-board-7fce3",storageBucket:"luis-board-7fce3.firebasestorage.app",messagingSenderId:"240713125754",appId:"1:240713125754:web:96ac6c06f6550fc713d0c3",measurementId:"G-PG237EKQYJ"},Pf=Mv(fN),Fa=xk(Pf),ma=qP(Pf),pN=new dn;uN(Pf);const ay="luismorenosofteng@gmail.com",Mn=[{id:"backlog",label:"Backlog",color:"#6B7280"},{id:"todo",label:"To Do",color:"#3B82F6"},{id:"inprogress",label:"In Progress",color:"#F59E0B"},{id:"done",label:"Done",color:"#10B981"}],bh=[{id:"low",label:"Low",color:"#6B7280"},{id:"medium",label:"Medium",color:"#F59E0B"},{id:"high",label:"High",color:"#EF4444"}],tE=["Job Search","Study","Personal","ASU","Finance","Other"],ly=Pk(Fa,"tickets");function mN(){const[t,e]=Ye.useState(window.innerWidth<768);return Ye.useEffect(()=>{const n=()=>e(window.innerWidth<768);return window.addEventListener("resize",n),()=>window.removeEventListener("resize",n)},[]),t}function gN({priority:t}){const e=bh.find(n=>n.id===t)||bh[1];return F.jsx("span",{style:{fontSize:"11px",fontWeight:700,letterSpacing:"0.08em",textTransform:"uppercase",color:e.color,border:`1px solid ${e.color}`,borderRadius:"4px",padding:"2px 7px"},children:e.label})}function yN({tag:t}){return F.jsx("span",{style:{fontSize:"11px",fontWeight:600,color:"#94A3B8",background:"#1E293B",borderRadius:"4px",padding:"2px 8px"},children:t})}function _N({visibility:t}){const e=t==="public";return F.jsx("span",{style:{fontSize:"11px",fontWeight:600,color:e?"#10B981":"#F59E0B",background:e?"#052e16":"#1c1007",border:`1px solid ${e?"#10B981":"#F59E0B"}`,borderRadius:"4px",padding:"2px 8px"},children:e?"🌐 Public":"🔒 Private"})}function vN({ticket:t,onEdit:e,onDelete:n,onMove:r,readOnly:i}){const s=Mn.findIndex(o=>o.id===t.status);return F.jsxs("div",{style:{background:"#0F172A",border:"1px solid #1E293B",borderRadius:"12px",padding:"16px",marginBottom:"12px",transition:"border-color 0.15s"},onMouseEnter:o=>o.currentTarget.style.borderColor="#334155",onMouseLeave:o=>o.currentTarget.style.borderColor="#1E293B",children:[F.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:8},children:[F.jsx("p",{style:{margin:0,fontFamily:"'DM Sans', sans-serif",fontWeight:600,fontSize:"15px",color:"#E2E8F0",lineHeight:1.4,flex:1},children:t.title}),!i&&F.jsxs("div",{style:{display:"flex",gap:6,flexShrink:0},children:[F.jsx("button",{onClick:()=>e(t),style:{background:"#1E293B",border:"1px solid #334155",borderRadius:"8px",cursor:"pointer",color:"#94A3B8",fontSize:"16px",padding:"6px 10px",lineHeight:1},children:"✏️"}),F.jsx("button",{onClick:()=>n(t.id),style:{background:"#1E293B",border:"1px solid #334155",borderRadius:"8px",cursor:"pointer",color:"#94A3B8",fontSize:"16px",padding:"6px 10px",lineHeight:1},children:"🗑️"})]})]}),t.description&&F.jsx("p",{style:{margin:"8px 0 12px",fontSize:"13px",color:"#64748B",fontFamily:"'DM Sans', sans-serif",lineHeight:1.5},children:t.description}),F.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap",marginBottom:12},children:[F.jsx(gN,{priority:t.priority}),t.tag&&F.jsx(yN,{tag:t.tag}),!i&&F.jsx(_N,{visibility:t.visibility||"private"})]}),!i&&F.jsxs("div",{style:{display:"flex",gap:8},children:[s>0&&F.jsxs("button",{onClick:()=>r(t.id,Mn[s-1].id),style:{flex:1,padding:"8px",background:"#1E293B",border:"1px solid #334155",borderRadius:"8px",color:"#94A3B8",cursor:"pointer",fontFamily:"'DM Sans', sans-serif",fontSize:"12px"},children:["← ",Mn[s-1].label]}),s<Mn.length-1&&F.jsxs("button",{onClick:()=>r(t.id,Mn[s+1].id),style:{flex:1,padding:"8px",background:"#1E293B",border:"1px solid #334155",borderRadius:"8px",color:"#94A3B8",cursor:"pointer",fontFamily:"'DM Sans', sans-serif",fontSize:"12px"},children:[Mn[s+1].label," →"]})]})]})}function wN({ticket:t,onSave:e,onClose:n,saving:r}){const[i,s]=Ye.useState(t||{title:"",description:"",status:"todo",priority:"medium",tag:"Personal",visibility:"private"});return F.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.8)",display:"flex",alignItems:"flex-end",justifyContent:"center",zIndex:1e3,padding:0},onClick:o=>o.target===o.currentTarget&&n(),children:F.jsxs("div",{style:{background:"#0F172A",border:"1px solid #1E293B",borderRadius:"20px 20px 0 0",padding:"24px 20px 36px",width:"100%",maxWidth:"600px",fontFamily:"'DM Sans', sans-serif",maxHeight:"92vh",overflowY:"auto"},children:[F.jsx("div",{style:{width:40,height:4,background:"#334155",borderRadius:2,margin:"0 auto 20px"}}),F.jsx("h2",{style:{margin:"0 0 20px",color:"#E2E8F0",fontSize:"20px",fontWeight:700},children:t!=null&&t.id?"Edit Ticket":"New Ticket"}),F.jsxs("div",{style:{marginBottom:16},children:[F.jsx("label",{style:{display:"block",fontSize:"11px",fontWeight:700,color:"#64748B",marginBottom:6,letterSpacing:"0.08em",textTransform:"uppercase"},children:"Title *"}),F.jsx("input",{value:i.title,onChange:o=>s({...i,title:o.target.value}),placeholder:"What needs to be done?",style:{width:"100%",background:"#1E293B",border:"1px solid #334155",borderRadius:"10px",color:"#E2E8F0",padding:"12px 14px",fontSize:"15px",fontFamily:"'DM Sans', sans-serif",boxSizing:"border-box",outline:"none"}})]}),F.jsxs("div",{style:{marginBottom:16},children:[F.jsx("label",{style:{display:"block",fontSize:"11px",fontWeight:700,color:"#64748B",marginBottom:6,letterSpacing:"0.08em",textTransform:"uppercase"},children:"Description"}),F.jsx("textarea",{value:i.description,onChange:o=>s({...i,description:o.target.value}),placeholder:"Optional details...",rows:3,style:{width:"100%",background:"#1E293B",border:"1px solid #334155",borderRadius:"10px",color:"#E2E8F0",padding:"12px 14px",fontSize:"15px",fontFamily:"'DM Sans', sans-serif",resize:"vertical",boxSizing:"border-box",outline:"none"}})]}),F.jsx("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:10,marginBottom:16},children:[{label:"Status",key:"status",options:Mn.map(o=>({value:o.id,label:o.label}))},{label:"Priority",key:"priority",options:bh.map(o=>({value:o.id,label:o.label}))},{label:"Tag",key:"tag",options:tE.map(o=>({value:o,label:o}))}].map(({label:o,key:l,options:u})=>F.jsxs("div",{children:[F.jsx("label",{style:{display:"block",fontSize:"11px",fontWeight:700,color:"#64748B",marginBottom:6,letterSpacing:"0.08em",textTransform:"uppercase"},children:o}),F.jsx("select",{value:i[l],onChange:h=>s({...i,[l]:h.target.value}),style:{width:"100%",background:"#1E293B",border:"1px solid #334155",borderRadius:"10px",color:"#E2E8F0",padding:"10px 8px",fontSize:"13px",fontFamily:"'DM Sans', sans-serif",outline:"none"},children:u.map(h=>F.jsx("option",{value:h.value,children:h.label},h.value))})]},l))}),F.jsxs("div",{style:{marginBottom:24},children:[F.jsx("label",{style:{display:"block",fontSize:"11px",fontWeight:700,color:"#64748B",marginBottom:8,letterSpacing:"0.08em",textTransform:"uppercase"},children:"Visibility"}),F.jsx("div",{style:{display:"flex",gap:10},children:[{value:"private",label:"🔒 Private",desc:"Only you can see this"},{value:"public",label:"🌐 Public",desc:"Visible on read-only link"}].map(o=>F.jsxs("button",{onClick:()=>s({...i,visibility:o.value}),style:{flex:1,padding:"12px",borderRadius:"10px",cursor:"pointer",fontFamily:"'DM Sans', sans-serif",textAlign:"left",background:i.visibility===o.value?"#1E293B":"transparent",border:`1px solid ${i.visibility===o.value?o.value==="public"?"#10B981":"#F59E0B":"#334155"}`},children:[F.jsx("div",{style:{fontSize:"14px",fontWeight:600,color:"#E2E8F0",marginBottom:2},children:o.label}),F.jsx("div",{style:{fontSize:"11px",color:"#64748B"},children:o.desc})]},o.value))})]}),F.jsxs("div",{style:{display:"flex",gap:10},children:[F.jsx("button",{onClick:n,style:{flex:1,padding:"14px",background:"none",border:"1px solid #334155",borderRadius:"10px",color:"#94A3B8",cursor:"pointer",fontFamily:"'DM Sans', sans-serif",fontSize:"15px"},children:"Cancel"}),F.jsx("button",{onClick:()=>i.title.trim()&&e(i),disabled:r,style:{flex:2,padding:"14px",background:r?"#1D4ED8":"#3B82F6",border:"none",borderRadius:"10px",color:"#fff",cursor:r?"not-allowed":"pointer",fontFamily:"'DM Sans', sans-serif",fontSize:"15px",fontWeight:700},children:r?"Saving...":t!=null&&t.id?"Save Changes":"Create Ticket"})]})]})})}function uy({readOnly:t,user:e,onSignOut:n}){const[r,i]=Ye.useState([]),[s,o]=Ye.useState(!0),[l,u]=Ye.useState(!1),[h,f]=Ye.useState(null),[g,_]=Ye.useState("all"),[A,P]=Ye.useState({}),x=mN();Ye.useEffect(()=>{const y=Kk(ly,m=>{i(m.docs.map(v=>({id:v.id,...v.data()}))),o(!1)});return()=>y()},[]);const V=async y=>{u(!0);try{if(y.id){const{id:m,...v}=y;await Og(Da(Fa,"tickets",m),{...v,updatedAt:mc()})}else await qk(ly,{...y,createdAt:mc()});f(null)}catch(m){alert("Error saving: "+m.message)}u(!1)},I=async y=>{window.confirm("Delete this ticket?")&&await Hk(Da(Fa,"tickets",y))},w=async(y,m)=>{await Og(Da(Fa,"tickets",y),{status:m,updatedAt:mc()})},S=y=>{P(m=>({...m,[y]:!m[y]}))},D=g==="all"?r:r.filter(y=>y.tag===g),j=t?D.filter(y=>(y.visibility||"private")==="public"):D,b=r.filter(y=>(y.visibility||"private")==="public").length;return F.jsxs("div",{style:{minHeight:"100vh",background:"#020617",fontFamily:"'DM Sans', sans-serif"},children:[F.jsx("link",{href:"https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&display=swap",rel:"stylesheet"}),F.jsxs("div",{style:{borderBottom:"1px solid #1E293B",padding:x?"14px 16px":"16px 24px",display:"flex",alignItems:"center",justifyContent:"space-between",position:"sticky",top:0,background:"#020617",zIndex:100},children:[F.jsxs("div",{children:[F.jsx("h1",{style:{margin:0,fontSize:x?"18px":"20px",fontWeight:700,color:"#E2E8F0",letterSpacing:"-0.3px"},children:"📋 Luis's Board"}),F.jsx("p",{style:{margin:"2px 0 0",fontSize:"12px",color:"#475569"},children:s?"Connecting...":t?`${b} public ticket${b!==1?"s":""} · 👁 Read-only`:`${r.length} ticket${r.length!==1?"s":""} · ✏️ Owner`})]}),F.jsxs("div",{style:{display:"flex",gap:8,alignItems:"center"},children:[!t&&F.jsx("button",{onClick:()=>f("new"),style:{background:"#3B82F6",border:"none",borderRadius:"10px",color:"#fff",padding:x?"10px 14px":"10px 18px",fontSize:x?"13px":"14px",fontWeight:700,cursor:"pointer",whiteSpace:"nowrap"},children:"+ New"}),e&&F.jsx("button",{onClick:n,style:{background:"none",border:"1px solid #1E293B",borderRadius:"10px",color:"#64748B",padding:"9px 12px",fontSize:"12px",cursor:"pointer",fontFamily:"'DM Sans', sans-serif",whiteSpace:"nowrap"},children:"Sign out"})]})]}),t&&F.jsx("div",{style:{background:"#0F172A",borderBottom:"1px solid #1E293B",padding:"10px 16px",textAlign:"center",fontSize:"12px",color:"#475569"},children:"👁 Read-only view · Only public tickets shown"}),F.jsx("div",{style:{padding:x?"12px 16px 0":"14px 24px 0",display:"flex",gap:8,overflowX:"auto",paddingBottom:0},children:["all",...tE].map(y=>F.jsx("button",{onClick:()=>_(y),style:{padding:"6px 14px",borderRadius:"20px",border:"1px solid",borderColor:g===y?"#3B82F6":"#1E293B",background:g===y?"#1D4ED8":"transparent",color:g===y?"#fff":"#64748B",fontSize:"12px",fontWeight:600,cursor:"pointer",whiteSpace:"nowrap",fontFamily:"'DM Sans', sans-serif"},children:y==="all"?"All":y},y))}),s&&F.jsx("div",{style:{textAlign:"center",padding:"80px 24px",color:"#475569",fontSize:"14px"},children:"Loading your board..."}),!s&&t&&b===0&&F.jsx("div",{style:{textAlign:"center",padding:"80px 24px",color:"#475569",fontSize:"14px"},children:"No public tickets yet."}),!s&&(!t||b>0)&&F.jsx("div",{style:{display:x?"flex":"grid",flexDirection:x?"column":void 0,gridTemplateColumns:x?void 0:"repeat(4, minmax(220px, 1fr))",gap:"12px",padding:x?"16px":"20px 24px 40px"},children:Mn.map(y=>{const m=j.filter(E=>E.status===y.id).sort((E,R)=>({high:0,medium:1,low:2})[E.priority]-{high:0,medium:1,low:2}[R.priority]),v=A[y.id];return F.jsxs("div",{style:{background:x?"#080F1E":"transparent",borderRadius:x?"14px":0,border:x?"1px solid #1E293B":"none",overflow:"hidden"},children:[F.jsxs("div",{onClick:()=>x&&S(y.id),style:{display:"flex",alignItems:"center",gap:8,padding:x?"14px 16px":"0 2px 12px",cursor:x?"pointer":"default",borderBottom:x&&!v?"1px solid #1E293B":"none"},children:[F.jsx("span",{style:{width:8,height:8,borderRadius:"50%",background:y.color,flexShrink:0}}),F.jsx("span",{style:{fontSize:"12px",fontWeight:700,textTransform:"uppercase",letterSpacing:"0.1em",color:"#64748B",flex:1},children:y.label}),F.jsx("span",{style:{background:"#1E293B",color:"#64748B",borderRadius:"10px",padding:"2px 8px",fontSize:"12px",fontWeight:700},children:m.length}),x&&F.jsx("span",{style:{color:"#475569",fontSize:"14px",marginLeft:4},children:v?"▶":"▼"})]}),!v&&F.jsx("div",{style:{padding:x?"12px":0,minHeight:x?0:"80px"},children:m.length===0?F.jsx("div",{style:{border:"1px dashed #1E293B",borderRadius:"10px",padding:"20px 16px",textAlign:"center",color:"#334155",fontSize:"12px"},children:"No tickets"}):m.map(E=>F.jsx(vN,{ticket:E,onEdit:f,onDelete:I,onMove:w,readOnly:t},E.id))})]},y.id)})}),h&&!t&&F.jsx(wN,{ticket:h==="new"?null:h,onSave:V,onClose:()=>f(null),saving:l})]})}function cy({onLogin:t,error:e}){return F.jsxs("div",{style:{minHeight:"100vh",background:"#020617",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'DM Sans', sans-serif",padding:24},children:[F.jsx("link",{href:"https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&display=swap",rel:"stylesheet"}),F.jsxs("div",{style:{textAlign:"center",width:"100%",maxWidth:400},children:[F.jsx("div",{style:{fontSize:"56px",marginBottom:16},children:"📋"}),F.jsx("h1",{style:{color:"#E2E8F0",fontSize:"32px",fontWeight:700,margin:"0 0 8px",letterSpacing:"-0.5px"},children:"Luis's Board"}),F.jsx("p",{style:{color:"#475569",fontSize:"15px",marginBottom:36},children:"Sign in to manage your tickets"}),e&&F.jsx("p",{style:{color:"#EF4444",fontSize:"13px",marginBottom:16,background:"#1E293B",padding:"12px 16px",borderRadius:10},children:e}),F.jsxs("button",{onClick:t,style:{display:"inline-flex",alignItems:"center",gap:12,background:"#fff",border:"none",borderRadius:"12px",padding:"15px 28px",fontSize:"16px",fontWeight:600,cursor:"pointer",color:"#1E293B",fontFamily:"'DM Sans', sans-serif",width:"100%",justifyContent:"center"},children:[F.jsx("img",{src:"https://www.google.com/favicon.ico",width:20,height:20,alt:"Google"}),"Continue with Google"]}),F.jsx("p",{style:{color:"#334155",fontSize:"12px",marginTop:20},children:"Only authorized accounts can sign in"})]})]})}function EN(){const[t,e]=Ye.useState(void 0),[n,r]=Ye.useState(""),i=window.location.hash==="#/view";Ye.useEffect(()=>{const o=LC(ma,l=>e(l));return()=>o()},[]);const s=async()=>{r("");try{(await tP(ma,pN)).user.email!==ay&&(await $g(ma),r("Access restricted to the board owner."))}catch{r("Sign-in failed. Please try again.")}};return i?F.jsx(uy,{readOnly:!0,user:null,onSignOut:null}):t===void 0?F.jsx("div",{style:{minHeight:"100vh",background:"#020617",display:"flex",alignItems:"center",justifyContent:"center"},children:F.jsx("p",{style:{color:"#475569",fontFamily:"'DM Sans', sans-serif"},children:"Loading..."})}):t?t.email!==ay?F.jsx(cy,{onLogin:s,error:"Access restricted to the board owner."}):F.jsx(uy,{readOnly:!1,user:t,onSignOut:()=>$g(ma)}):F.jsx(cy,{onLogin:s,error:n})}Iv(document.getElementById("root")).render(F.jsx(Ye.StrictMode,{children:F.jsx(EN,{})}));
